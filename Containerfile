...
RUN pacman -Syu linux-firmware --noconfirm
...
RUN pacman -S --noconfirm base dracut linux-cachyos-bore ostree systemd btrfs-progs e2fsprogs xfsprogs binutils dosfstools skopeo dbus dbus-glib glib2 shadow
